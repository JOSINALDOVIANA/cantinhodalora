...
import {FaceIcon,ListAlt} from '@mui/icons-material';
...
export default function ComplexGrid({ img, desc, tamanho, valor, logos, bg, id,und }) {
    ...
    return (
     ...
     <Paper
        ...
        sx={{
            ...
            fontFamily: "Roboto",
            alignItems: "center",
            background:und>=1?"transparent":"#ddd",
            position: "relative",
    ...
    <div style={{width:100,height:100,marginTop:10,marginBottom:2}}>
        ...
        <Divider sx={{ margin: 1, marginTop: 2, width: "90%" }}>
            <Chip label="Informações" icon={<ListAlt color={"success"}/>} color={"success"} variant="outlined"/>
        </Divider>
