        ...
        <tr>
          ...
          <td>
            ...
            <svg id="ver" style={{ margin: 0 }} onClick={() => {
              ...
              document.querySelector("#ocut").classList.remove("none")
            ...
            <svg id='ocut'  onClick={() => {
              document.querySelector(`${"#password" + dados.id}`).type = "password"
              document.querySelector("#ver").classList.remove("none")
              document.querySelector("#ocut").classList.add("none")
            }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-eye-slash none" viewBox="0 0 16 16">
